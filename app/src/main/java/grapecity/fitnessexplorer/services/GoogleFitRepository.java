...
import grapecity.fitnessexplorer.factories.GoogleApiClientFactory;
...
public class GoogleFitRepository implements IFitnessRepository, GoogleApiClient.ConnectionCallbacks
{
    ...
    GoogleFitEntityTranslator entityTranslator;
    List<IRepositoryChangeListener> stateListeners = new ArrayList<>();
    RepositoryState currentState = RepositoryState.CONNECTING;
    Activity activity;
