...
import com.grapecity.xuni.calendar.CalendarDaySlot;
...
import com.grapecity.xuni.calendar.IDaySlotTemplate;
...
public class CalendarDashboardView extends DashboardView
{
    ...
    Context context;
    RandomColorFactory colorFactory;
    private final SimpleDateFormat df2 = new SimpleDateFormat("MM/dd/yyyy HH:mm:ss");
    ...
    {
        final RandomColorFactory colorFactory = new RandomColorFactory();
    ...
    public void setCalendar(List<DayActivities> activitiesThisMonth)
    {
        ...
        for(int i=0; i<activitiesThisMonth.size(); i++)
        {
            monthActivities.add(activitiesThisMonth.get(i));
        }
